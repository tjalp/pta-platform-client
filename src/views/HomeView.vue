    ...
    <div class="card flex justify-center">
        ...
        <Dialog v-model:visible="dialogVisible" modal header="PTA Zoeken" :style="{ width: '25rem' }">
            ...
            <div class="flex justify-end gap-2">
                <Button type="button" label="Annuleren" severity="secondary" @click="dialogVisible = false"></Button>
                <Button type="button" label="Zoeken" @click="dialogVisible = false"></Button>
            </div>
        </Dialog>
    </div>
</template>
...
function filterSubjects() {
    ...
    filteredSubjectNames.value = subjectNames
    subject.value = null
}
